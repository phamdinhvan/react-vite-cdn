...
l.nextTick = function(o) {
  ...
  if (arguments.length > 1)
    for (var b = 1; b < arguments.length; b++)
      d[b - 1] = arguments[b];
  x.push(new Ve(o, d)), x.length === 1 && !L && We(Ye);
};
function Ve(o, d) {
...
function kr() {
  if (Ie) return N;
  Ie = 1;
  var o = Le, d = Symbol.for("react.element"), b = Symbol.for("react.fragment"), A = Object.prototype.hasOwnProperty, Z = o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, q = { key: !0, ref: !0, __self: !0, __source: !0 };
  function M(j, p, F) {
    ...
    function hr(e, r, t, n, u) {
      {
        ...
        return pr(e, a, h, u, n, V.current, i);
      }
    }
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, ie, P, wr, P), Fe[P + ie] = !0;
          }
        }
...
function $r() {
  const [o, d] = Cr(0);
  return console.log("====>count", o), /* @__PURE__ */ y.jsxs(y.Fragment, { children: [
